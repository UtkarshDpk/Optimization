...
minperf = min(T,[],2);% dimension 2 - row wise
...
grid on;
title(sprintf('Performence Profile: Number of Iterations: %d',N));
legend('Newton','BFGS','Inv BFGS','DFP','Inv DFP');
legend('Location','southeast');
xlabel('Tau'); ylabel('Performence Profile');
